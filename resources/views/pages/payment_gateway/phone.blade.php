                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="col-sm-6">
                            <input name="agent" value="Mobile Money" class="form-control" type="text" id="agent">
                            </div>
                            </div>
                            <div class="form-group row">
                            <label for="public_key" class="col-sm-4 col-form-label">Phone <i class="text-danger">*</i></label>
                             <div class="col-sm-6">
                            <input name="public_key" value="+880 1746 40 68 01" class="form-control" type="text" id="public_key" required="">
                            </div>
                            </div>
                            <div class="form-group row">
